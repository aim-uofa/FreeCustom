...
from pipelines.pipeline_controlnet_freecustom import StableDiffusionControlNetFreeCustomPipeline
...
if __name__ == "__main__":
    ...
    # load config
    cfg = OmegaConf.load("configs/config_controlnet.yaml")
    print(f'config: {cfg}')
    ...
    model = StableDiffusionControlNetFreeCustomPipeline.from_pretrained(cfg.model_path, controlnet=controlnet, scheduler=scheduler).to(device)
    ...
    canny_image = Image.open(cfg.canny_image_path)
    ...
    for seed in cfg.seeds:
        ...
        images.save(os.path.join(results_dir, f"controlnet_freecustom_{seed}.png"))
